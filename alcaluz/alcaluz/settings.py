"""
Django settings for alcaluz project.
...
SECRET_KEY = 'django-insecure-=a(_yl!m2)8z6btvyi4u2vr3zuo1v2h@ynt_*r)(ov%s!d0o)j'
...
WSGI_APPLICATION = 'alcaluz.wsgi.application'
...
STATIC_URL = 'static/'
# Esto le dice a Django que busque carpetas "static" dentro de cada app instalada
STATICFILES_FINDERS = [
